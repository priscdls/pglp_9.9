...
public abstract class GroupeFormeDaoJDBC {
	 ...
	 */
	public static void createGroupeCercle(final Connection c, final String nom, final String nom2) {
		try {
			final int un = 1;
			final int deux = 2;
	 ...
	 */
	public static void createGroupeCarre(final Connection c, final String nom, final String nom2) {
		try {
			final int un = 1;
			final int deux = 2;
			PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void createGroupeRectangle(final Connection c, final String nom, final String nom2) {
		try {
			final int un = 1;
			final int deux = 2;
			PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void createGroupeTriangle(final Connection c, final String nom, final String nom2) {
		try {
			final int un = 1;
			final int deux = 2;
			PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void createGroupeGroupe(final Connection c, final String nom, final String nom2) {
		try {
			final int un = 1;
			final int deux = 2;
			PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void deleteCercleGroupe(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 * @param nom Le nom du groupe
	 */
	public static void deleteGroupeCercle(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void deleteCarreGroupe(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 * @param nom Le nom du groupe
	 */
	public static void deleteGroupeCarre(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void deleteRectangleGroupe(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 * @param nom Le nom du groupe
	 */
	public static void deleteGroupeRectangle(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void deleteTriangleGroupe(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 * @param nom Le nom du groupe
	 */
	public static void deleteGroupeTriangle(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 */
	public static void deleteGroupe2Groupe(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	...
	/**
	 * Supprime les associations d'un groupe "contenant" vers d'autres groupes.
	 * @param c Le connecteur
	 * @param nom Le nom du groupe "contenant"
	 */
	public static void deleteGroupeGroupe2(final Connection c, final String nom) {
		final int un = 1;
        try {
            PreparedStatement prepare = c.prepareStatement(
	 ...
	 * @param nom Le nom du groupe
	 */
	public static void deleteAllGroupeForme(final Connection c, final String nom) {
	 ...
	 */
	public static ArrayList<Forme> findGroupeCercle(final Connection connect, final String nom) {
	 ...
	 */
	public static ArrayList<Forme> findGroupeCarre(final Connection connect, final String nom) {
		ArrayList<Forme> f = new ArrayList<Forme>();
        try {
            final int un = 1;
            PreparedStatement prepare = connect.prepareStatement(
	 ...
	 */
	public static ArrayList<Forme> findGroupeRectangle(final Connection connect, final String nom) {
		ArrayList<Forme> f = new ArrayList<Forme>();
        try {
            final int un = 1;
            PreparedStatement prepare = connect.prepareStatement(
                    "SELECT NomRectangle FROM GroupeRectangle WHERE NomGroupe = ?");
            prepare.setString(un, nom);
            ResultSet result = prepare.executeQuery();
            while (result.next()) {
            	FactoryDaoJDBC fdj = (FactoryDaoJDBC) AbstractFactoryDao.getFactory(DaoType.JDBC);
	 ...
	 */
	public static ArrayList<Forme> findGroupeTriangle(final Connection connect, final String nom) {
		ArrayList<Forme> f = new ArrayList<Forme>();
        try {
            final int un = 1;
            PreparedStatement prepare = connect.prepareStatement(
                    "SELECT NomTriangle FROM GroupeTriangle WHERE NomGroupe = ?");
            prepare.setString(un, nom);
            ResultSet result = prepare.executeQuery();
            while (result.next()) {
            	FactoryDaoJDBC fdj = (FactoryDaoJDBC) AbstractFactoryDao.getFactory(DaoType.JDBC);
	 ...
	 */
	public static ArrayList<Forme> findGroupeGroupe(final Connection connect, final String nom) {
		ArrayList<Forme> f = new ArrayList<Forme>();
        try {
            final int un = 1;
            PreparedStatement prepare = connect.prepareStatement(
	 ...
	 */
	public static ArrayList<Forme> findAllGroupeForme(final Connection c, final String nom) {
